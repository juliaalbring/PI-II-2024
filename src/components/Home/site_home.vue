...
.intro {
  ...
  padding-top: 13rem;
  padding-bottom: 90px;
  clip-path: polygon(50% 10%, 100% 0, 100% 35%, 100% 100%, 100% 100%, 50% 100%, 0 100%, 0 0, 0 0);
...
.singlediv:hover{
  ...
  .hub {
    padding-top: 13rem;
    clip-path: polygon(50% 9%, 100% 0, 100% 35%, 100% 100%, 100% 100%, 50% 100%, 0 100%, 0 100%, 0 0, 0 0);
    background-color: #080e22; 
    text-align: center;
    justify-content: center;
    gap: 10%;
